...
const SPECS: Spec[] = [
  // --- general aviation ---
  { id: 'c172', name: 'Cessna 172 Skyhawk', maker: 'Cessna', family: 'ga', cls: 'light', speed: 50, turn: 2.4, hull: 13, wind: 1.0, engines: 'prop1', body: '#fff8ee', accent: '#ff7a59', shape: ga(13), callsign: 'Skyhawk' },
  ...
  { id: 'sr22', name: 'Cirrus SR22', maker: 'Cirrus', family: 'ga', cls: 'light', speed: 58, turn: 2.3, hull: 13, wind: 0.95, engines: 'prop1', body: '#f7fbff', accent: '#e0413e', shape: ga(13, { low: true }), callsign: 'Cirrus' },
  ...
  { id: 'dhc6', name: 'DHC-6 Twin Otter', maker: 'De Havilland', family: 'ga', cls: 'light', speed: 58, turn: 2.0, hull: 17, wind: 0.85, engines: 'prop2', body: '#fffaf0', accent: '#3aa0d8', shape: ga(17, { twin: true, long: 2.6 }), callsign: 'Twin Otter' },
  { id: 'c208', name: 'Cessna 208 Caravan', maker: 'Cessna', family: 'ga', cls: 'light', speed: 54, turn: 2.1, hull: 15, wind: 0.9, engines: 'prop1', body: '#fff6e0', accent: '#f2b53a', shape: ga(15, { long: 2.6 }), callsign: 'Caravan' },
  // --- turboprops ---
  ...
  { id: 'r44', name: 'Robinson R44', maker: 'Robinson', family: 'heli', cls: 'heli', speed: 38, turn: 3.6, hull: 10, wind: 1.2, engines: 'rotor', body: '#fffbe6', accent: '#1f6feb', shape: heli(10), callsign: 'Robinson' },
  { id: 'aw139', name: 'Leonardo AW139', maker: 'Leonardo', family: 'heli', cls: 'heli', speed: 48, turn: 3.2, hull: 14, wind: 1.0, engines: 'rotor', body: '#fff7e6', accent: '#f59e0b', shape: heli(14), callsign: 'Rescue' },
  { id: 's92', name: 'Sikorsky S-92', maker: 'Sikorsky', family: 'heli', cls: 'heli', speed: 46, turn: 3.0, hull: 16, wind: 0.95, engines: 'rotor', body: '#eef2ff', accent: '#0b3d91', shape: heli(16), callsign: 'Sikorsky' },
  // --- seaplanes ---
  { id: 'c208a', name: 'Cessna 208 Caravan Amphibian', maker: 'Cessna', family: 'sea', cls: 'sea', speed: 54, turn: 2.1, hull: 15, wind: 0.95, engines: 'float', body: '#fff6e0', accent: '#f2b53a', shape: { ...ga(15, { long: 2.6 }), floats: true }, callsign: 'Caravan' },
  { id: 'dhc6f', name: 'DHC-6 Twin Otter (drijvers)', maker: 'De Havilland', family: 'sea', cls: 'sea', speed: 56, turn: 2.0, hull: 17, wind: 0.9, engines: 'float', body: '#fffaf0', accent: '#0aa35e', shape: { ...ga(17, { twin: true, long: 2.6 }), floats: true }, callsign: 'Twin Otter' },
  { id: 'icona5', name: 'ICON A5', maker: 'ICON', family: 'sea', cls: 'sea', speed: 44, turn: 2.6, hull: 11, wind: 1.1, engines: 'float', body: '#ffffff', accent: '#e0413e', shape: { ...ga(11), floats: true }, callsign: 'Icon' },
  // --- military ---
  ...
  { id: 'chinook', name: 'Boeing CH-47 Chinook', maker: 'Boeing Defense', family: 'heli', cls: 'heli', speed: 50, turn: 2.8, hull: 18, wind: 0.9, engines: 'rotor', body: MIL_GREEN, accent: MIL_DARK, shape: heli(18, { tandem: true }), callsign: 'Chinook', military: true, fuel: 70 },
  { id: 'nh90', name: 'NH90', maker: 'NHIndustries', family: 'heli', cls: 'heli', speed: 48, turn: 3.0, hull: 15, wind: 0.95, engines: 'rotor', body: MIL_GREEN, accent: MIL_DARK, shape: heli(15), callsign: 'Merlin', military: true, fuel: 70 },
];
