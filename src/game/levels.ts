...
export const LEVELS: LevelDef[] = [
  {
    ...
    islands: [
      { cx: 0.52, cy: 0.80, rx: 0.46, ry: 0.23, seed: 101, style: 'meadow',
        decor: [ { kind: 'village', x: 0.22, y: 0.86 }, { kind: 'tower', x: 0.66, y: 0.74 }, { kind: 'hangar', x: 0.70, y: 0.86 }, { kind: 'windmill', x: 0.86, y: 0.80 } ] },
      { cx: 0.14, cy: 0.12, rx: 0.13, ry: 0.075, seed: 102, style: 'pine',
        decor: [ { kind: 'lighthouse', x: 0.10, y: 0.10 } ] },
    ],
    runways: [ { id: 'rw1', kind: 'short', x: 0.52, y: 0.67, heading: S, length: 280 } ],
  ...
  },
  {
    ...
    islands: [
      { cx: 0.62, cy: 0.82, rx: 0.44, ry: 0.21, seed: 201, style: 'meadow',
        decor: [ { kind: 'terminal', x: 0.80, y: 0.76 }, { kind: 'tower', x: 0.80, y: 0.70 }, { kind: 'village', x: 0.36, y: 0.90 }, { kind: 'hangar', x: 0.82, y: 0.86 } ] },
    ...
    runways: [ { id: 'rw1', kind: 'long', x: 0.62, y: 0.66, heading: S, length: 380 } ],
  ...
  },
  {
    ...
    islands: [
      { cx: 0.46, cy: 0.83, rx: 0.50, ry: 0.20, seed: 301, style: 'meadow',
        decor: [ { kind: 'windmill', x: 0.12, y: 0.80 }, { kind: 'windmill', x: 0.20, y: 0.90 }, { kind: 'windmill', x: 0.84, y: 0.84 }, { kind: 'tower', x: 0.62, y: 0.74 }, { kind: 'terminal', x: 0.64, y: 0.82 }, { kind: 'village', x: 0.30, y: 0.92 } ] },
    ...
    runways: [ { id: 'rw1', kind: 'long', x: 0.46, y: 0.67, heading: S, length: 380 } ],
  ...
  },
  {
    ...
    islands: [
      { cx: 0.22, cy: 0.76, rx: 0.23, ry: 0.25, seed: 401, style: 'pine',
        decor: [ { kind: 'village', x: 0.10, y: 0.90 }, { kind: 'hangar', x: 0.32, y: 0.78 } ] },
      { cx: 0.74, cy: 0.81, rx: 0.27, ry: 0.22, seed: 402, style: 'meadow',
        decor: [ { kind: 'terminal', x: 0.90, y: 0.78 }, { kind: 'tower', x: 0.90, y: 0.72 }, { kind: 'castle', x: 0.60, y: 0.94 } ] },
      { cx: 0.50, cy: 0.12, rx: 0.10, ry: 0.06, seed: 403, style: 'tropic', decor: [ { kind: 'lighthouse', x: 0.50, y: 0.11 } ] },
    ],
    runways: [
      { id: 'rwS', kind: 'short', x: 0.22, y: 0.62, heading: S, length: 260 },
      { id: 'rwL', kind: 'long', x: 0.74, y: 0.66, heading: S, length: 380 },
    ],
  ...
  },
  {
    ...
    islands: [
      { cx: 0.64, cy: 0.84, rx: 0.40, ry: 0.19, seed: 501, style: 'tropic',
        decor: [ { kind: 'terminal', x: 0.82, y: 0.80 }, { kind: 'tower', x: 0.82, y: 0.74 }, { kind: 'village', x: 0.40, y: 0.94 }, { kind: 'castle', x: 0.94, y: 0.92 } ] },
      { cx: 0.14, cy: 0.88, rx: 0.13, ry: 0.10, seed: 502, style: 'tropic', decor: [ { kind: 'hangar', x: 0.14, y: 0.90 } ] },
  ...
  },
  {
    ...
    islands: [
      { cx: 0.50, cy: 0.82, rx: 0.50, ry: 0.22, seed: 601, style: 'meadow',
        decor: [ { kind: 'castle', x: 0.86, y: 0.72 }, { kind: 'terminal', x: 0.56, y: 0.78 }, { kind: 'tower', x: 0.56, y: 0.72 }, { kind: 'village', x: 0.12, y: 0.92 }, { kind: 'windmill', x: 0.08, y: 0.78 }, { kind: 'hangar', x: 0.58, y: 0.88 } ] },
      { cx: 0.80, cy: 0.20, rx: 0.17, ry: 0.10, seed: 602, style: 'pine', decor: [ { kind: 'lighthouse', x: 0.66, y: 0.16 } ] },
    ],
    runways: [
      { id: 'rwL', kind: 'long', x: 0.34, y: 0.66, heading: S, length: 380 },
      { id: 'rwS', kind: 'short', x: 0.82, y: 0.14, heading: S, length: 230 },
      { id: 'rwH', kind: 'helipad', x: 0.78, y: 0.86, heading: S, length: 1 },
    ],
